...
--
-- Host: localhost
-- Generation Time: Sep 24, 2012 at 05:21 PM
...
(1, 'polligraf', 'polligraf', 0, 0, 0, 0, '2012-09-24 16:15:19', '2012-09-24 16:15:19', '1.0'),
(2, 'Motorsport', 'motorsport', 0, 0, 0, 0, '2012-09-24 16:43:33', '2012-09-24 16:43:33', '1.0');
...
(1, 4, 5, 20, 5, 'Home Page', 'home-page', 'Test!', '', '', '', '', '', '', '', '', 1, 0, 0, 1, 0, '', 'Hi David', '', 0, 0, '', '');
...
(1, 'main', 'main', '', '', '<p class="success thq">{%Message}</p>', '', '', '<p class="alert thq">{%Message}</p>', '', '', '<p class="error thq">{%Message}</p>', '', '', 1, 0),
(2, 'wsc  -main', 'wsc-main', '', '<div class="alertYellow cmAlert clear">\r\n    <div class="alertBottom">\r\n        <p class="bulb">', '{%Message}<br />\r\n', '        </p>\r\n        <a href="#" class="closeAlert imgReplace">close</a>\r\n    </div>\r\n</div>\r\n', '<div class="alertYellow cmAlert clear">\r\n    <div class="alertBottom">\r\n        <p class="bulb">', '{%Message}<br />\r\n', '        </p>\r\n        <a href="#" class="closeAlert imgReplace">close</a>\r\n    </div>\r\n</div>\r\n', '<div class="alertYellow cmAlert clear">\r\n    <div class="alertBottom">\r\n        <p class="bulb">', '{%Message}<br />\r\n', '        </p>\r\n        <a href="#" class="closeAlert imgReplace">close</a>\r\n    </div>\r\n</div>\r\n', '', 1, 0),
(3, 'in page', 'in-page', '<div class="errors">\r\n<div class="wrapper">', '<ul class="green">', '<li>{%Message}</li>', '</ul>', '<ul class="orange">', '<li>{%Message}</li>', '</ul>', '<ul class="red">', '<li>{%Message}</li>', '</ul>', '</div>\r\n</div>', 1, 0);
...
(1, 'admin', 'ondrej.rafaj@gmail.com', '26150cd292e4450ab8e6f799cce7b391bf2f1aef', 'Ondrej', 'Rafaj', '2012-09-24 15:07:00', '127.0.0.1', 1, '1348501413', '69389', 1, ''),
...
(1, 2, 'ondrej', 'ondrej.rafaj@gmail.com', '26150cd292e4450ab8e6f799cce7b391bf2f1aef', 'que?', 'pasa', '2009-03-02 13:18:27', '2009-03-02 13:17:00', '2010-02-04 10:51:44', '', '', 1, '2012-09-24 10:17:52', 'm', '127.0.0.1', 'Ondrej', 'Rafaj', 56, 0, 0, '');
...
(5, 'Page login', 'page-login', 6, 0, 0, 0, 0, 'nickname', 0, '33', '10', '', '<form action="" method="post">\r\n	<p>\r\n		<label>Username / Email</label>\r\n		<input type="text" name="login" value="{%AutoName}" />\r\n	</p>\r\n	<p>\r\n		<label>Password</label>\r\n		<input type="password" name="password" value="" />\r\n	</p>\r\n	<!--<p>\r\n		<label>Remember login</label>\r\n		<input type="checkbox" name="remember" value="1" />\r\n	</p>-->\r\n	<p>\r\n		<input type="submit" name="submit" value="Login" />\r\n	</p>\r\n</form>', '', '<div>\r\n	<h1>{%Lastname}, {%Firstname}</h1>\r\n	<p>Avatar: {%Avatar}</p>\r\n	<p>Nickname: {%Nickname}</p>\r\n	<p>Email: {%Mail}</p>\r\n	<p>Account created: {%Added}</p>\r\n	<p>Last login: {%Lastlogin}</p>\r\n	<p>Last login from: {%Lastip}</p>\r\n	<p>Country: {%Country}</p>\r\n	<p>Group: {%Group}</p>\r\n	 <p><a href="?logout">Logout</a></p>\r\n</div>', 'Sorry, unrecognized username or password.', 'You have been logged in successfully.', '', 'You don''t have enough permissions for this section.', 'logoutmess'),
(6, 'Login line', 'login-line', 6, 0, 0, 0, 0, 'info', 0, '0', '10', '', '<div class="loginLine">\r\n 	<div class="wrapper">\r\n       <ul class="left">\r\n            <!--<li>Welcome to xProgress.com</li>-->\r\n        </ul>\r\n        <ul class="right">\r\n            <li><a href="{#LINK_34}" title="Register to the system">Register</a></li>\r\n            <li><a href="{#LINK_39}" title="Login to the system">Login</a></li>\r\n            <li><a href="{#LINK_40}" title="Have you forgotten your password?">Forgotten password?</a></li>\r\n        </ul>\r\n	</div>\r\n</div>\r\n', '', '<div class="loginLine">\r\n	<div class="wrapper">\r\n        <ul class="left">\r\n            <li>Hi {%Firstname}, are you ready for some action today?</li>\r\n        </ul>\r\n        <ul class="right">\r\n            <li><a href="{#LINK_33}" title="My account administration page">My account</a></li>\r\n            <li><a href="?logout=1" title="Log-out from the system">Logout</a></li>\r\n        </ul>\r\n	</div>\r\n</div>\r\n', 'wrongloginmess', 'loggeginmess', '', 'wrongpermsmess', 'You have been successfuly logged out.'),

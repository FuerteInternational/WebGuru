...
DROP TABLE IF EXISTS `bp_technologies`;
CREATE TABLE `bp_technologies` (
...
(1, 4, 5, 23, 14, 'Home Page', 'home-page', 'Login', 'Login', '', '', '', '', '', '', '', 1, 0, 0, 1, 6, '<style>\r\n#errors {\r\n	width:600px;\r\n	margin-top:50px;\r\n	margin-bottom:-30px;\r\n	margin-left:auto;\r\n	margin-right:auto;\r\n	text-align:center;\r\n	font-size:12px;\r\n}\r\n#errors ul {\r\n}\r\n#errors ul.red li {\r\n	color:#900;\r\n}\r\n#errors ul.green li {\r\n	color: #090;\r\n}\r\n#errors ul.orange li {\r\n	color:#C60;\r\n}\r\n#errors ul li {\r\n	margin-bottom:12px;\r\n}\r\n</style>', 'This page is managed through it''s template!', '', 0, 0, '', ''),
...
DROP TABLE IF EXISTS `templateswitch`;
CREATE TABLE `templateswitch` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(150) NOT NULL,
  `identifier` varchar(150) NOT NULL,

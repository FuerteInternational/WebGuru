...
--
-- Host: localhost
-- Generation Time: Oct 09, 2012 at 06:57 PM
...
(2, 4, 5, 20, 11, 'My Apps', 'my-apps', 'My Apps', 'My Apps', '', '', '', '', '', '', '', 1, 0, 0, 0, 4, '<script type="text/javascript" src="http://code.jquery.com/jquery-1.8.2.min.js"></script>', '{#TEMP_add-new-app}\r\n<div class="content">\r\n		{#FRONTEND_mobileapps_appslist}\r\n        {#FRONTEND_mobileapps_appdetail}\r\n</div>', '...', 1, 0, 'You have to be logged in to access this section!', ''),
...
(27, 5, 'Add new app', 'add-new-app', 0, 4, 1, 0, '<?php if (moduleUsers::isAdmin()) { ?><div class="actionButtons">\r\n    <a href="{#WEBROOT}/admin/?part=system&mod=mobileapps&page=apps" class="button" onclick="return togglePopupWindow()">Add new app</a>\r\n</div>\r\n<?php } ?>', '...');
...
(1, 'admin', 'ondrej.rafaj@gmail.com', '26150cd292e4450ab8e6f799cce7b391bf2f1aef', 'Ondrej', 'Rafaj', '2012-10-09 18:54:09', '127.0.0.1', 1, '1349809009', '21994', 1, '');
...
(1, 'Main template', 'main-template', 'somo');
...
(1, 1, 'ondrej', 'ondrej.rafaj@gmail.com', '26150cd292e4450ab8e6f799cce7b391bf2f1aef', 'que?', 'pasa', '2009-03-02 13:18:27', '2009-03-02 13:17:00', '2012-10-02 18:59:50', '', '', 1, '2012-10-09 19:49:12', 'm', '192.168.105.178', 'Ondrej', 'Rafaj', 56, 0, 0, ''),

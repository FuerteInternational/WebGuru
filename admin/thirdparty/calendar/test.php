...
// put here the correct path to "../../addons/calendar/calendar.php"; don't move the file
// "../../addons/calendar/calendar.php" -- I think it's best if you leave it inside the

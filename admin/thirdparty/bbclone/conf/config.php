 ...
 *
 * $Header: /cvs/bbclone/conf/config.php,v 1.70 2007/03/08 22:40:30 christoph Exp $
 *
...
// oddities...
$BBC_MAXBROWSER = 30;         // Browsers
$BBC_MAXEXTENSION = 30;       // Extensions
$BBC_MAXOS = 30;              // Operating Systems
$BBC_MAXROBOT = 30;           // Robots

$BBC_MAXHOST = 30;            // Hosts (reset possible)
$BBC_MAXKEY = 30;             // Keywords (reset possible)
$BBC_MAXORIGIN = 30;          // Referrers (reset possible)
$BBC_MAXPAGE = 30;            // Pages (reset possible)

...
class wgError {
	...
	/**
	 * Name of the error array in $system variable
	 *
	 */
	const ERR_PART = 'wgError';
	...
	public static function add($message, $group=0) {
		...
		$err = &$_SESSION['system'][self::ERR_PART]['messages'];
	...
	public static function getErrors() {
		if (!isset($_SESSION['system'][self::ERR_PART]['messages'])) $_SESSION['system'][self::ERR_PART]['messages'] = array();
		return $_SESSION['system'][self::ERR_PART]['messages'];
	}
	...
	public static function getErrorsGroups() {
		if (!isset($_SESSION['system'][self::ERR_PART]['groups'])) $_SESSION['system'][self::ERR_PART]['groups'] = array();
		return $_SESSION['system'][self::ERR_PART]['groups'];
	}
	...
	public static function setErrors($errors=array()) {
		$_SESSION['system'][self::ERR_PART]['messages'] = $errors;
	}
	...
	public static function setErrorsGroups($groups=array()) {
		$_SESSION['system'][self::ERR_PART]['groups'] = $groups;
	}
	...
	public static function addGroup($message=NULL, $identifier='errorred') {
		...
		$err = &$_SESSION['system'][self::ERR_PART]['groups'];
	...
	public static function clearSession() {
		$_SESSION['system'][self::ERR_PART] = array();
		$_SESSION['system'][self::ERR_PART]['groups'] = array();
		$_SESSION['system'][self::ERR_PART]['messages'] = array();
	}
	...
	public static function createGroups() {
		if (!isset($_SESSION['system'][self::ERR_PART]['groups'][0])) self::addGroup(NULL, 'wgerrorred');
		if (!isset($_SESSION['system'][self::ERR_PART]['groups'][1])) self::addGroup(NULL, 'wgerrororange');
		if (!isset($_SESSION['system'][self::ERR_PART]['groups'][2])) self::addGroup(NULL, 'wgerrorgreen');
	}
}
?>
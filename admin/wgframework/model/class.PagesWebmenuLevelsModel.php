 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/pages_webmenu_levels
 * @author       Ondrej Rafaj ()
...
class PagesWebmenuLevelsModel extends BasePagesWebmenuLevelsModel {
	
	
	// --------------------- Predefined functions for PagesWebmenuLevels ---------------------
	...
	/*
	public static function getOneSelfData($idPagesWebmenuLevels) {
		$id = (int) $idPagesWebmenuLevels;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);
			$conn->limit(1);
		...
		else return new PagesWebmenuLevelsModel();
	}
	//*/

 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/forms_qfields
 * @author       Ondrej Rafaj ()
...
class FormsQfieldsModel extends BaseFormsQfieldsModel {
	
	
	// --------------------- Predefined functions for FormsQfields ---------------------
	...
	/*
	public static function getOneSelfData($idFormsQfields) {
		$id = (int) $idFormsQfields;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);
			$conn->limit(1);
		...
		else return new FormsQfieldsModel();
	}
	//*/

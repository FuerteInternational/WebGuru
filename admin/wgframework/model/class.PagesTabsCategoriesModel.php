 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/pages_tabs_categories
 * @author       Ondrej Rafaj ()
...
class PagesTabsCategoriesModel extends BasePagesTabsCategoriesModel {
	
	
	// --------------------- Predefined functions for PagesTabsCategories ---------------------
	...
	/*
	public static function getOneSelfData($idPagesTabsCategories) {
		$id = (int) $idPagesTabsCategories;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);
			$conn->limit(1);
		...
		else return new PagesTabsCategoriesModel();
	}
	//*/

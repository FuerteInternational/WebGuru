 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/padchat_groups
 * @author       Ondrej Rafaj ()
...
class PadchatGroupsModel extends BasePadchatGroupsModel {
	
	
	// --------------------- Predefined functions for PadchatGroups ---------------------
	...
	/*
	public static function getOneSelfData($idPadchatGroups) {
		$id = (int) $idPadchatGroups;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);
			$conn->limit(1);
		...
		else return new PadchatGroupsModel();
	}
	//*/

 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/search_queries
 * @author       Ondrej Rafaj ()
...
class SearchQueriesModel extends BaseSearchQueriesModel {
	
	
	// --------------------- Predefined functions for SearchQueries ---------------------
	...
	/*
	public static function getOneSelfData($idSearchQueries) {
		$id = (int) $idSearchQueries;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);
			$conn->limit(1);
		...
		else return new SearchQueriesModel();
	}
	//*/

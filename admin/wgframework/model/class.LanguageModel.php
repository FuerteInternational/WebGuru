 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/language
 * @author       Ondrej Rafaj ()
...
class LanguageModel extends BaseLanguageModel {
	
	
	// --------------------- Predefined functions for Language ---------------------
	...
	/*
	public static function getOneSelfData($idLanguage) {
		$id = (int) $idLanguage;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);

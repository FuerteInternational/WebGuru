 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/tracker_days
 * @author       Ondrej Rafaj ()
...
class TrackerDaysModel extends BaseTrackerDaysModel {
	
	
	// --------------------- Predefined functions for TrackerDays ---------------------
	...
	/*
	public static function getOneSelfData($idTrackerDays) {
		$id = (int) $idTrackerDays;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);
			$conn->limit(1);
		...
		else return new TrackerDaysModel();
	}
	//*/

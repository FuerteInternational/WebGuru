 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/search_results
 * @author       Ondrej Rafaj ()
...
class SearchResultsModel extends BaseSearchResultsModel {
	
	
	// --------------------- Predefined functions for SearchResults ---------------------
	...
	/*
	public static function getOneSelfData($idSearchResults) {
		$id = (int) $idSearchResults;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);
			$conn->limit(1);
		...
		else return new SearchResultsModel();
	}
	//*/

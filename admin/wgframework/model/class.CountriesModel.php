 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/countries
 * @author       Ondrej Rafaj ()
...
class CountriesModel extends BaseCountriesModel {
	
	
	// --------------------- Predefined functions for Countries ---------------------
	...
	/*
	public static function getOneSelfData($idCountries) {
		$id = (int) $idCountries;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);
		...
		else return new CountriesModel();
	}
	//*/

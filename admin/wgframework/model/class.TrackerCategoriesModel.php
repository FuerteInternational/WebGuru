 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/tracker_categories
 * @author       Ondrej Rafaj ()
...
class TrackerCategoriesModel extends BaseTrackerCategoriesModel {
	
	
	// --------------------- Predefined functions for TrackerCategories ---------------------
	...
	/*
	public static function getOneSelfData($idTrackerCategories) {
		$id = (int) $idTrackerCategories;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);
			$conn->limit(1);
		...
		else return new TrackerCategoriesModel();
	}
	//*/

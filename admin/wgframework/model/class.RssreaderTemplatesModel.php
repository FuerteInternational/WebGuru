 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/rssreader_templates
 * @author       Ondrej Rafaj ()
 * @author       WebGuruCMS3 Framework CMS dbModel generator (http://www.webgurucms.com)
 * @version      1.0.0.0
 * @wgversion    3.0.0.0
 * @since        18. August 2009 15:01:50
 */

class RssreaderTemplatesModel extends BaseRssreaderTemplatesModel {
	
	
	// --------------------- Predefined functions for RssreaderTemplates ---------------------
	...
	public static function getTemplateByIdentifierAndType($identifier, $type=0) {
		...
		else return new RssreaderTemplatesModel();
	}
	//*/
...
/*
	...
	/*
	public static function getOneSelfData($idRssreaderTemplates) {
		$id = (int) $idRssreaderTemplates;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);
			$conn->limit(1);

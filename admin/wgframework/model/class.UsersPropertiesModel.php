 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/users_properties
 * @author       Ondrej Rafaj ()
...
class UsersPropertiesModel extends BaseUsersPropertiesModel {
	
	
	// --------------------- Predefined functions for UsersProperties ---------------------
	...
	/*
	public static function getOneSelfData($idUsersProperties) {
		$id = (int) $idUsersProperties;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);
			$conn->limit(1);
		...
		else return new UsersPropertiesModel();
	}
	//*/

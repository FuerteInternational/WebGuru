 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/xchat_groups
 * @author       Ondrej Rafaj ()
...
class XchatGroupsModel extends BaseXchatGroupsModel {
	
	
	// --------------------- Predefined functions for XchatGroups ---------------------
	...
	/*
	public static function getOneSelfData($idXchatGroups) {
		$id = (int) $idXchatGroups;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);
			$conn->limit(1);
		...
		else return new XchatGroupsModel();
	}
	//*/

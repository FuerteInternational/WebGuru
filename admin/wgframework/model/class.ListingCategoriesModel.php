 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/listing_categories
 * @author       Ondrej Rafaj ()
...
class ListingCategoriesModel extends BaseListingCategoriesModel {
	
	
	// --------------------- Predefined functions for ListingCategories ---------------------
	...
	/*
	public static function getOneSelfData($idListingCategories) {
		$id = (int) $idListingCategories;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);
			$conn->limit(1);
		...
		else return new ListingCategoriesModel();
	}
	//*/

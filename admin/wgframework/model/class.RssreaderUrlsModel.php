 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/rssreader_urls
 * @author       Ondrej Rafaj ()
 * @author       WebGuruCMS3 Framework CMS dbModel generator (http://www.webgurucms.com)
 * @version      1.0.0.0
 * @wgversion    3.0.0.0
 * @since        18. August 2009 15:01:32
 */

class RssreaderUrlsModel extends BaseRssreaderUrlsModel {
	
	
	// --------------------- Predefined functions for RssreaderUrls ---------------------
	...
	/*
	public static function getOneSelfData($idRssreaderUrls) {
		$id = (int) $idRssreaderUrls;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);
			$conn->limit(1);
		...
		else return new RssreaderUrlsModel();
	}
	//*/

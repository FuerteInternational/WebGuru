 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/mtemps_clients
 * @author       Ondrej Rafaj ()
...
class MtempsClientsModel extends BaseMtempsClientsModel {
	
	
	// --------------------- Predefined functions for MtempsClients ---------------------
	...
	/*
	public static function getOneSelfData($idMtempsClients) {
		$id = (int) $idMtempsClients;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);
			$conn->limit(1);
		...
		else return new MtempsClientsModel();
	}
	//*/

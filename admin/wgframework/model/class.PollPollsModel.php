 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/poll_polls
 * @author       Ondrej Rafaj ()
...
class PollPollsModel extends BasePollPollsModel {
	
	
	// --------------------- Predefined functions for PollPolls ---------------------
	...
	/*
	public static function getOneSelfData($idPollPolls) {
		$id = (int) $idPollPolls;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);
		...
		else return new PollPollsModel();
	}
	//*/

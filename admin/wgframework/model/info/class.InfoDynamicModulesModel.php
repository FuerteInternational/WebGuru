 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/info/dynamic_modules
 * @author       Ondrej Rafaj ()
...
class InfoDynamicModulesModel {
	
	const ENGINE = 'MyISAM';
	
	const TABLE = 'dynamic_modules';
	...
	const COL_CATEGORIES_COLATION = NULL;
		
	const COL_ITEMS_COLATION = NULL;
		
	const COL_TEMPLATES_COLATION = NULL;

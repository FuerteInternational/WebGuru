 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/info/payments_costs
 * @author       Ondrej Rafaj ()
 * @author       WebGuruCMS3 Framework CMS dbModel generator (http://www.webgurucms.com)
 * @version      1.0.0.0
 * @wgversion    3.0.0.0
 * @since        20. February 2010 18:57:52
 */

class InfoPaymentsCostsModel {
	
	const ENGINE = 'MyISAM';
	
	const TABLE = 'payments_costs';

 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/search_queries_categories
 * @author       Ondrej Rafaj ()
...
class SearchQueriesCategoriesModel extends BaseSearchQueriesCategoriesModel {
	
	
	// --------------------- Predefined functions for SearchQueriesCategories ---------------------
	...
	/*
	public static function getOneSelfData($idSearchQueriesCategories) {
		$id = (int) $idSearchQueriesCategories;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);
			$conn->limit(1);
		...
		else return new SearchQueriesCategoriesModel();
	}
	//*/

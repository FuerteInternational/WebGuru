 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/search_frontend
 * @author       Ondrej Rafaj ()
...
class SearchFrontendModel extends BaseSearchFrontendModel {
	
	
	// --------------------- Predefined functions for SearchFrontend ---------------------
	...
	/*
	public static function getOneSelfData($idSearchFrontend) {
		$id = (int) $idSearchFrontend;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);
			$conn->limit(1);
		...
		else return new SearchFrontendModel();
	}
	//*/

 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/iblog_urls
 * @author       Ondrej Rafaj ()
...
class IblogUrlsModel extends BaseIblogUrlsModel {
	
	
	// --------------------- Predefined functions for IblogUrls ---------------------
	...
	/*
	public static function getOneSelfData($idIblogUrls) {
		$id = (int) $idIblogUrls;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);
		...
		else return new IblogUrlsModel();
	}
	//*/

 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/padchat_messages
 * @author       Ondrej Rafaj ()
 * @author       WebGuruCMS3 Framework CMS dbModel generator (http://www.webgurucms.com)
 * @version      1.0.0.0
 * @wgversion    3.0.0.0
 * @since        8. February 2010 16:43:54
 */

class PadchatMessagesModel extends BasePadchatMessagesModel {
	
	
	// --------------------- Predefined functions for PadchatMessages ---------------------
	...
	/*
	public static function getOneSelfData($idPadchatMessages) {
		$id = (int) $idPadchatMessages;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);
			$conn->limit(1);
		...
		else return new PadchatMessagesModel();
	}
	//*/

 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/news_fronttemps
 * @author       Ondrej Rafaj ()
...
class NewsFronttempsModel extends BaseNewsFronttempsModel {
	
	
	// --------------------- Predefined functions for NewsFronttemps ---------------------
	...
	/*
	public static function getOneSelfData($idNewsFronttemps) {
		$id = (int) $idNewsFronttemps;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);
			$conn->limit(1);
		...
		else return new NewsFronttempsModel();
	}
	//*/

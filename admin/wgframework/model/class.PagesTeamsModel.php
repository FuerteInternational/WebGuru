 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/pages_teams
 * @author       Ondrej Rafaj ()
...
class PagesTeamsModel extends BasePagesTeamsModel {
	
	
	// --------------------- Predefined functions for PagesTeams ---------------------
	...
	/*
	public static function getOneSelfData($idPagesTeams) {
		$id = (int) $idPagesTeams;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);
		...
		else return new PagesTeamsModel();
	}
	//*/

 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/poll_points
 * @author       Ondrej Rafaj ()
...
class PollPointsModel extends BasePollPointsModel {
	
	
	// --------------------- Predefined functions for PollPoints ---------------------
	...
	/*
	public static function getOneSelfData($idPollPoints) {
		$id = (int) $idPollPoints;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);
		...
		else return new PollPointsModel();
	}
	//*/

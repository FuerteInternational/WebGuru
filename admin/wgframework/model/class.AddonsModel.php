 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/addons
 * @author       Ondrej Rafaj ()
...
class AddonsModel extends BaseAddonsModel {
	
	
	// --------------------- Predefined functions for Addons ---------------------
	...
	/*
	public static function getOneSelfData($idAddons) {
		$id = (int) $idAddons;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);

 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/chuckles_messages
 * @author       Ondrej Rafaj ()
 * @author       WebGuruCMS3 Framework CMS dbModel generator (http://www.webgurucms.com)
 * @version      1.0.0.0
 * @wgversion    3.0.0.0
 * @since        25. November 2009 11:25:10
 */

class ChucklesMessagesModel extends BaseChucklesMessagesModel {
	
	
	// --------------------- Predefined functions for ChucklesMessages ---------------------
	...
	/*
	public static function getOneSelfData($idChucklesMessages) {
		$id = (int) $idChucklesMessages;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);
			$conn->limit(1);
		...
		else return new ChucklesMessagesModel();
	}
	//*/

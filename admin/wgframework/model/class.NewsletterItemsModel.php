 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/newsletter_items
 * @author       Ondrej Rafaj ()
...
class NewsletterItemsModel extends BaseNewsletterItemsModel {
	
	
	// --------------------- Predefined functions for NewsletterItems ---------------------
	...
	/*
	public static function getOneSelfData($idNewsletterItems) {
		$id = (int) $idNewsletterItems;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);
			$conn->limit(1);
		...
		else return new NewsletterItemsModel();
	}
	//*/

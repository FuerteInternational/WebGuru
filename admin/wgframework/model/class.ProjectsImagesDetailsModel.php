 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/projects_images_details
 * @author       Ondrej Rafaj ()
...
class ProjectsImagesDetailsModel extends BaseProjectsImagesDetailsModel {
	
	
	// --------------------- Predefined functions for ProjectsImagesDetails ---------------------
	...
	/*
	public static function getOneSelfData($idProjectsImagesDetails) {
		$id = (int) $idProjectsImagesDetails;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);
			$conn->limit(1);
		...
		else return new ProjectsImagesDetailsModel();
	}
	//*/

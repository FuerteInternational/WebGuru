 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/imessages_messages
 * @author       Ondrej Rafaj ()
 * @author       WebGuruCMS3 Framework CMS dbModel generator (http://www.webgurucms.com)
 * @version      1.0.0.0
 * @wgversion    3.0.0.0
 * @since        1. February 2010 13:18:34
 */

class ImessagesMessagesModel extends BaseImessagesMessagesModel {
	
	
	// --------------------- Predefined functions for ImessagesMessages ---------------------
	...
	/*
	public static function getOneSelfData($idImessagesMessages) {
		$id = (int) $idImessagesMessages;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);
			$conn->limit(1);
		...
		else return new ImessagesMessagesModel();
	}
	//*/

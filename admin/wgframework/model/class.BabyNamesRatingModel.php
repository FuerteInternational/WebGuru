 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/_baby_names_rating
 * @author       Ondrej Rafaj ()
 * @author       WebGuruCMS3 Framework CMS dbModel generator (http://www.webgurucms.com)
 * @version      1.0.0.0
 * @wgversion    3.0.0.0
 * @since        21. January 2010 14:19:03
 */

class BabyNamesRatingModel extends BaseBabyNamesRatingModel {
	
	
	// --------------------- Predefined functions for BabyNamesRating ---------------------
	...
	/*
	public static function getOneSelfData($idBabyNamesRating) {
		$id = (int) $idBabyNamesRating;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);
			$conn->limit(1);
		...
		else return new BabyNamesRatingModel();
	}
	//*/

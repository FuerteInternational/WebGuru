 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/pages2
 * @author       Ondrej Rafaj ()
...
class Pages2Model extends BasePages2Model {
	
	
	// --------------------- Predefined functions for Pages2 ---------------------
	...
	/*
	public static function getOneSelfData($idPages2) {
		$id = (int) $idPages2;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);

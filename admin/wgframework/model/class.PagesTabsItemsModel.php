 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/pages_tabs_items
 * @author       Ondrej Rafaj ()
...
class PagesTabsItemsModel extends BasePagesTabsItemsModel {
	
	
	// --------------------- Predefined functions for PagesTabsItems ---------------------
	...
	/*
	public static function getOneSelfData($idPagesTabsItems) {
		$id = (int) $idPagesTabsItems;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);
			$conn->limit(1);
		...
		else return new PagesTabsItemsModel();
	}
	//*/

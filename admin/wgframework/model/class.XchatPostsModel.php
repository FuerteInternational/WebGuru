 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/xchat_posts
 * @author       Ondrej Rafaj ()
...
class XchatPostsModel extends BaseXchatPostsModel {
	
	
	// --------------------- Predefined functions for XchatPosts ---------------------
	...
	/*
	public static function getOneSelfData($idXchatPosts) {
		$id = (int) $idXchatPosts;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);
		...
		else return new XchatPostsModel();
	}
	//*/

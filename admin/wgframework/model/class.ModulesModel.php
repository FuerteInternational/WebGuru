 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/modules
 * @author       Ondrej Rafaj ()
...
class ModulesModel extends BaseModulesModel {
	
	
	// --------------------- Predefined functions for Modules ---------------------
	...
	/*
	public static function getOneSelfData($idModules) {
		$id = (int) $idModules;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);

...
class BasePaymentsCategoriesModel extends DbModel {
	...
	/** Left join select function from table payments_categories
	 * 
	 * @name doLeftJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Right join select function from table payments_categories
	 * 
	 * @name doRightJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Inner join select function from table payments_categories
	 * 
	 * @name doInnerJoin
	 * @param array $params
	 * @return array Array of the items from database

...
class BaseCronUserjobsLogModel extends DbModel {
	...
	/** Left join select function from table cron_userjobs_log
	 * 
	 * @name doLeftJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Right join select function from table cron_userjobs_log
	 * 
	 * @name doRightJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Inner join select function from table cron_userjobs_log
	 * 
	 * @name doInnerJoin
	 * @param array $params
	 * @return array Array of the items from database

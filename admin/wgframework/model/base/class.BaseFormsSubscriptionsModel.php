...
class BaseFormsSubscriptionsModel extends DbModel {
	...
	/** Left join select function from table forms_subscriptions
	 * 
	 * @name doLeftJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Right join select function from table forms_subscriptions
	 * 
	 * @name doRightJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Inner join select function from table forms_subscriptions
	 * 
	 * @name doInnerJoin
	 * @param array $params
	 * @return array Array of the items from database

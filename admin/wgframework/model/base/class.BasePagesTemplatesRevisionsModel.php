...
class BasePagesTemplatesRevisionsModel extends DbModel {
	...
	/** Left join select function from table pages_templates_revisions
	 * 
	 * @name doLeftJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Right join select function from table pages_templates_revisions
	 * 
	 * @name doRightJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Inner join select function from table pages_templates_revisions
	 * 
	 * @name doInnerJoin
	 * @param array $params
	 * @return array Array of the items from database

...
class BaseIwallpapersImagesModel extends DbModel {
	...
	/** Left join select function from table iwallpapers_images
	 * 
	 * @name doLeftJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Right join select function from table iwallpapers_images
	 * 
	 * @name doRightJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Inner join select function from table iwallpapers_images
	 * 
	 * @name doInnerJoin
	 * @param array $params
	 * @return array Array of the items from database

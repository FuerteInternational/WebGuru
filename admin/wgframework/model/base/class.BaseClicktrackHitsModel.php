...
class BaseClicktrackHitsModel extends DbModel {
	...
	/** Left join select function from table clicktrack_hits
	 * 
	 * @name doLeftJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Right join select function from table clicktrack_hits
	 * 
	 * @name doRightJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Inner join select function from table clicktrack_hits
	 * 
	 * @name doInnerJoin
	 * @param array $params
	 * @return array Array of the items from database

...
class BaseCronUserjobsModel extends DbModel {
	...
	/** Left join select function from table cron_userjobs
	 * 
	 * @name doLeftJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Right join select function from table cron_userjobs
	 * 
	 * @name doRightJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Inner join select function from table cron_userjobs
	 * 
	 * @name doInnerJoin
	 * @param array $params
	 * @return array Array of the items from database

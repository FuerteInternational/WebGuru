...
class BaseYoutubeVideosModel extends DbModel {
	...
	/** Left join select function from table youtube_videos
	 * 
	 * @name doLeftJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Right join select function from table youtube_videos
	 * 
	 * @name doRightJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Inner join select function from table youtube_videos
	 * 
	 * @name doInnerJoin
	 * @param array $params
	 * @return array Array of the items from database

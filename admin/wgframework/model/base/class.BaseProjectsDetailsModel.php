...
class BaseProjectsDetailsModel extends DbModel {
	...
	/** Left join select function from table projects_details
	 * 
	 * @name doLeftJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Right join select function from table projects_details
	 * 
	 * @name doRightJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Inner join select function from table projects_details
	 * 
	 * @name doInnerJoin
	 * @param array $params
	 * @return array Array of the items from database

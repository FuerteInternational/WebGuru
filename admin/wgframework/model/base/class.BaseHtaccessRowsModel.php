...
class BaseHtaccessRowsModel extends DbModel {
	...
	/** Left join select function from table htaccess_rows
	 * 
	 * @name doLeftJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Right join select function from table htaccess_rows
	 * 
	 * @name doRightJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Inner join select function from table htaccess_rows
	 * 
	 * @name doInnerJoin
	 * @param array $params
	 * @return array Array of the items from database

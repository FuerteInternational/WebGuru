...
class BaseLanguagesTranslationsModel extends DbModel {
	...
	/** Left join select function from table languages_translations
	 * 
	 * @name doLeftJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Right join select function from table languages_translations
	 * 
	 * @name doRightJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Inner join select function from table languages_translations
	 * 
	 * @name doInnerJoin
	 * @param array $params
	 * @return array Array of the items from database

...
class BaseUsersMessagesModel extends DbModel {
	...
	/** Left join select function from table users_messages
	 * 
	 * @name doLeftJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Right join select function from table users_messages
	 * 
	 * @name doRightJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Inner join select function from table users_messages
	 * 
	 * @name doInnerJoin
	 * @param array $params
	 * @return array Array of the items from database

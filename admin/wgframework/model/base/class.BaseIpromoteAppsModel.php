...
class BaseIpromoteAppsModel extends DbModel {
	...
	/** Left join select function from table ipromote_apps
	 * 
	 * @name doLeftJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Right join select function from table ipromote_apps
	 * 
	 * @name doRightJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Inner join select function from table ipromote_apps
	 * 
	 * @name doInnerJoin
	 * @param array $params
	 * @return array Array of the items from database

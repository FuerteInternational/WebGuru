...
class BasePaymentsPermissionsModel extends DbModel {
	...
	/** Left join select function from table payments_permissions
	 * 
	 * @name doLeftJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Right join select function from table payments_permissions
	 * 
	 * @name doRightJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Inner join select function from table payments_permissions
	 * 
	 * @name doInnerJoin
	 * @param array $params
	 * @return array Array of the items from database

...
class BasePaymentsServicesModel extends DbModel {
	...
	/** Left join select function from table payments_services
	 * 
	 * @name doLeftJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Right join select function from table payments_services
	 * 
	 * @name doRightJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Inner join select function from table payments_services
	 * 
	 * @name doInnerJoin
	 * @param array $params
	 * @return array Array of the items from database

...
class BaseImessagesRecipientsModel extends DbModel {
	...
	/** Left join select function from table imessages_recipients
	 * 
	 * @name doLeftJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Right join select function from table imessages_recipients
	 * 
	 * @name doRightJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Inner join select function from table imessages_recipients
	 * 
	 * @name doInnerJoin
	 * @param array $params
	 * @return array Array of the items from database

...
class BaseCrawlerResultsModel extends DbModel {
	...
	/** Left join select function from table crawler_results
	 * 
	 * @name doLeftJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Right join select function from table crawler_results
	 * 
	 * @name doRightJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Inner join select function from table crawler_results
	 * 
	 * @name doInnerJoin
	 * @param array $params
	 * @return array Array of the items from database

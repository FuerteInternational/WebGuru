...
class BaseMotocatalogueBrandsModel extends DbModel {
	...
	/** Left join select function from table motocatalogue_brands
	 * 
	 * @name doLeftJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Right join select function from table motocatalogue_brands
	 * 
	 * @name doRightJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Inner join select function from table motocatalogue_brands
	 * 
	 * @name doInnerJoin
	 * @param array $params
	 * @return array Array of the items from database

...
class BaseRssreaderUrlsModel extends DbModel {
	...
	/** Left join select function from table rssreader_urls
	 * 
	 * @name doLeftJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Right join select function from table rssreader_urls
	 * 
	 * @name doRightJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Inner join select function from table rssreader_urls
	 * 
	 * @name doInnerJoin
	 * @param array $params
	 * @return array Array of the items from database

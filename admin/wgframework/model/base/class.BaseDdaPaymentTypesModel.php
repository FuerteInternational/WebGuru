...
class BaseDdaPaymentTypesModel extends DbModel {
	...
	/** Left join select function from table dda_payment_types
	 * 
	 * @name doLeftJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Right join select function from table dda_payment_types
	 * 
	 * @name doRightJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Inner join select function from table dda_payment_types
	 * 
	 * @name doInnerJoin
	 * @param array $params
	 * @return array Array of the items from database

...
class BaseSystemLanguageModel extends DbModel {
	...
	/** Left join select function from table system_language
	 * 
	 * @name doLeftJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Right join select function from table system_language
	 * 
	 * @name doRightJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Inner join select function from table system_language
	 * 
	 * @name doInnerJoin
	 * @param array $params
	 * @return array Array of the items from database

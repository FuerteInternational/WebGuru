...
class BaseSystemValidationsModel extends DbModel {
	...
	/** Left join select function from table system_validations
	 * 
	 * @name doLeftJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Right join select function from table system_validations
	 * 
	 * @name doRightJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Inner join select function from table system_validations
	 * 
	 * @name doInnerJoin
	 * @param array $params
	 * @return array Array of the items from database

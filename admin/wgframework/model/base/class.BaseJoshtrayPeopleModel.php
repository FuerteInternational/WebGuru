...
class BaseJoshtrayPeopleModel extends DbModel {
	...
	/** Left join select function from table joshtray_people
	 * 
	 * @name doLeftJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Right join select function from table joshtray_people
	 * 
	 * @name doRightJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Inner join select function from table joshtray_people
	 * 
	 * @name doInnerJoin
	 * @param array $params
	 * @return array Array of the items from database

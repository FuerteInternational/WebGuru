...
class BaseDynamicColumnsModel extends DbModel {
	...
	/** Left join select function from table dynamic_columns
	 * 
	 * @name doLeftJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Right join select function from table dynamic_columns
	 * 
	 * @name doRightJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Inner join select function from table dynamic_columns
	 * 
	 * @name doInnerJoin
	 * @param array $params
	 * @return array Array of the items from database

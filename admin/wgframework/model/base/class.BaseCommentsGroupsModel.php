...
class BaseCommentsGroupsModel extends DbModel {
	...
	/** Left join select function from table comments_groups
	 * 
	 * @name doLeftJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Right join select function from table comments_groups
	 * 
	 * @name doRightJoin
	 * @param array $params
	 * @return array Array of the items from database
	...
	/** Inner join select function from table comments_groups
	 * 
	 * @name doInnerJoin
	 * @param array $params
	 * @return array Array of the items from database

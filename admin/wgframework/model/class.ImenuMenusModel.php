 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/imenu_menus
 * @author       Ondrej Rafaj ()
...
class ImenuMenusModel extends BaseImenuMenusModel {
	
	
	// --------------------- Predefined functions for ImenuMenus ---------------------
	...
	public static function getOneSelfData($idImenuMenus) {
		$id = (int) $idImenuMenus;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);
		...
		else return new ImenuMenusModel();
	}

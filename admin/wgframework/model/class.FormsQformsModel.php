 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/forms_qforms
 * @author       Ondrej Rafaj ()
...
class FormsQformsModel extends BaseFormsQformsModel {
	
	
	// --------------------- Predefined functions for FormsQforms ---------------------
	...
	/*
	public static function getOneSelfData($idFormsQforms) {
		$id = (int) $idFormsQforms;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);
			$conn->limit(1);
		...
		else return new FormsQformsModel();
	}
	//*/

 ...
 * 
 * @package      WebGuru3
 * @subpackage   wgframework/model/ipromote_templates
 * @author       Ondrej Rafaj ()
 * @author       WebGuruCMS3 Framework CMS dbModel generator (http://www.webgurucms.com)
 * @version      1.0.0.0
 * @wgversion    3.0.0.0
 * @since        25. August 2009 18:16:46
 */

class IpromoteTemplatesModel extends BaseIpromoteTemplatesModel {
	
	
	// --------------------- Predefined functions for IpromoteTemplates ---------------------
	...
	public static function getTemplateByIdentifierAndType($identifier, $type=0) {
		...
		else return new IpromoteTemplatesModel();
	}
	...
	/*
	public static function getOneSelfData($idIpromoteTemplates) {
		$id = (int) $idIpromoteTemplates;
		if ((bool) $id) {
			$conn = new wgConnector();
			$conn->where(parent::COL_ID, $id);
			$conn->limit(1);

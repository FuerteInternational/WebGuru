...
final class appsActionsMobileapps extends BaseActions {
	/**
	 ...
	 *
	 */
	public function init() { wgError::add("You have run the test action in mobileappsActionsApps class (".__LINE__."=>".__FILE__.")", 1);
		return true;
	}

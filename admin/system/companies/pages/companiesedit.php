<?php
/**
 * Page companiesedit for module Companies
 * 
 * @package      WebGuru3
...
// ----------- editcompanies (Block: editcompanies) start -----------
$block = 'editcompanies';
$tpl = new wgParse($temp, $path);
$tpl->setCurrentBlock($block);

$var['ACTIONNAME'] = 'companiesediteditcompanies';
...
if (!empty($arr['data']) && is_array($arr['data'])) foreach ($arr['data'] as $val) {
	$tpl->setCurrentBlock('listeditcompanies');
	$lv['LID'] = $val->getId();
	...
	$tpl->setVariable($lv);
	$tpl->parseBlock('listeditcompanies');
...
$tab->addTab('editcompanies', wgLang::get('editcompanies'), true, $tpl->getBlock($block));
// ----------- editcompanies end -----------

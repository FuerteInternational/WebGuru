...
wgSystem::defPostValue(UsersModel::COL_SYSTEM_COUNTRIES_ID, 222);
$lv = array();
$item = new UsersModel();
...
$var['COLID'] = (int)$item->getId();
$var['HIDENOEDIT'] = ($var['COLID']) ? '' : ' style="display:none;"';
$var['SOMETIMESMANDATORY'] = (!$var['COLID']) ? ' class="mandatory"' : '';
$var['SOMETIMESMANDATORYSTAR'] = (!$var['COLID']) ? '*' : '';
$params = array();
...
$var['COLPASSWORDORCHANGE'] = ($var['COLID']) ? wgLang::get('changepasswordto') : wgLang::get('setnewpassword');
$var['COLPASSWORD'] = '';
...
$var['FULLCOLONLINE'] = wgSystem::formatDate($item->getOnline());
...
$var['COLFULLGENDER'] = formsHelper::getSelectBox('gender', $item->getGender(), array('m'=>wgLang::get('male'), 'f'=>wgLang::get('female'), 'u'=>wgLang::get('unspec')), $params);

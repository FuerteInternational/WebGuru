<?php
/**
 * Action class for module iPhone gallery
 * 
 * @package      WebGuru3
...
class actionsIgallery extends actions {
	...
	private function _doIndexJob($parameters) {
		...
		$class = new igalleryActionsIndex();
	...
	private function _doAlbumsJob($parameters) {
		...
		$class = new igalleryActionsAlbums();
		if ((bool) $class->init()) { wgError::add('actionok', 2);
			return true;
		}
		else { wgError::add('actionfailed');
	...
	private function _doPhotosJob($parameters) {
		...
		$class = new igalleryActionsPhotos();
		if ((bool) $class->init()) { wgError::add('actionok', 2);
			return true;
		}
		else { wgError::add('actionfailed');
	...
	private function _doSettingsJob($parameters) {
		...
		$class = new igalleryActionsSettings();
		if ((bool) $class->init()) { wgError::add('actionok', 2);
			return true;
		}
		else { wgError::add('actionfailed');
	...
	private function _doTemplatesJob($parameters) {
		...
		$class = new igalleryActionsTemplates();
		if ((bool) $class->init()) { wgError::add('actionok', 2);
			return true;
		}
		else { wgError::add('actionfailed');

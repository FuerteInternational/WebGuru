<?php
/**
 * Action class for module Subscriptions
 * 
 * @package      WebGuru3
...
class actionsSubscriptions extends actions {
	
	public function __construct($parameters) {
		$func = array();
		// SYSTEM: functions-list -------------------------------------------------------------
		$func['doindexjob'] = array('doIndexJob', 'index');
		$func['dolistsjob'] = array('doListsJob', 'lists');
	...
	private function _doIndexJob($parameters) {
		...
		$class = new subscriptionsActionsIndex();
	...
	/**
	 * This is the _doListsJob function description
	 *
	 * @name _doListsJob
	 * @author Ondrej Rafaj
	 * @param array $parameters Params from url
	...
	private function _doTemplatesJob($parameters) {
		...
		$class = new subscriptionsActionsTemplates();
		if ((bool) $class->init()) { wgError::add('actionok', 2);
			return true;
		}
		else { wgError::add('actionfailed');

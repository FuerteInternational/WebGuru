<?php
/**
 * Action class for module Ratings
 * 
 * @package      WebGuru3
...
class actionsRatings extends actions {
	...
	private function _doGroupsJob($parameters) {
		...
		$class = new ratingsActionsGroups();
		if ((bool) $class->init()) { wgError::add('actionok', 2);
			return true;
		}
		else { wgError::add('actionfailed');
	...
	private function _doTemplatesJob($parameters) {
		...
		$class = new ratingsActionsTemplates();
		if ((bool) $class->init()) { wgError::add('actionok', 2);
			return true;
		}
		else { wgError::add('actionfailed');

<?php
/**
 * Page comments for module Blogger
 * 
 * @package      WebGuru3
...
$var['ACTIONNAME'] = 'commentscomments';
...
if (!empty($arr['data']) && is_array($arr['data'])) foreach ($arr['data'] as $val) {
	...
	if (wgSystem::getRequestValue('edit') == $val->getId() && wgSystem::getRequestValue('show') == 'commentscomments') $item = $val;
}
